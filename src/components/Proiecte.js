      ...
      <div class="work-container" data-aos="fade-up" data-aos-offset="180">
        <div class="work-list">
          ...
          <figure
            onClick={() => {
              setIsOpen(true);
              setCurrentImage(require("../img/img2.jpg"));
            }}
            class="item-container"
          >
          ...
          <figure
            onClick={() => {
              setIsOpen(true);
              setCurrentImage(require("../img/img3.jpg"));
            }}
            class="item-container"
          >
          ...
          <figure
            onClick={() => {
              setIsOpen(true);
              setCurrentImage(require("../img/img4.jpg"));
            }}
            class="item-container"
          >
          ...
          <figure
            onClick={() => {
              setIsOpen(true);
              setCurrentImage(require("../img/img5.jpg"));
            }}
            class="item-container"
          >
          ...
          <figure
            onClick={() => {
              setIsOpen(true);
              setCurrentImage(require("../img/img6.jpg"));
            }}
            class="item-container"
          >
          ...
          <figure
            onClick={() => {
              setIsOpen(true);
              setCurrentImage(require("../img/img7.jpg"));
            }}
            class="item-container"
          >
          ...
          <figure
            onClick={() => {
              setIsOpen(true);
              setCurrentImage(require("../img/img8.jpg"));
            }}
            class="item-container"
          >
          ...
          <figure
            onClick={() => {
              setIsOpen(true);
              setCurrentImage(require("../img/img9.jpg"));
            }}
            class="item-container"
          >
